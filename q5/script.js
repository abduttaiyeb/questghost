(function() {
  ...
  MESSAGES.push({
    delay: 1200,
    text: "The pictures which captured a moment giving time a materialistic form,"
  });

  MESSAGES.push({
    delay: 2200,
    text: "stumbling across one on a hectic day left me both cold and warm."
  });

  MESSAGES.push({
    delay: 3600,
    text: "The warm memories of and with you buried in the deep and dusty corner of my heart get revived,"
  });

  MESSAGES.push({
    delay: 5200,
    text: "Captured past momentarily stopped the moving present as the beautiful tears of nostalgia arrived."
  });

MESSAGES.push({
    delay: 6200,
    text: "That perpetual joy and playful innocence is not around me anymore,"
  });

MESSAGES.push({
    delay: 7400,
    text: "Responsibilities won't allow it to return no matter how much I implore."
  });

MESSAGES.push({
    delay: 8600,
    text: "Locking away this eternal source of memory and laugh,"
  });

MESSAGES.push({
    delay: 9600,
    text: "Time adds more to the tragic beauty of a nostalgic photograph."
  });
